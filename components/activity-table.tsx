                ...
                Object.entries(groupedActivities).map(([date, dayActivities]) => (
                    <div key={date} className="space-y-3">
                        ...
                        <div className="space-y-0.5">
                            {/* Header Row */}
                            <div className="grid grid-cols-[80px_140px_1fr_1fr_120px_60px] gap-4 px-4 py-2 text-[10px] font-mono text-white/40 uppercase tracking-wider">
                                <div>Time</div>
                                <div>App</div>
                                <div>Received</div>
                                <div>Sent</div>
                            ...
                            {dayActivities.map((activity, i) => (
                                <div
                                    ...
                                    className="grid grid-cols-[80px_140px_1fr_1fr_120px_60px] gap-4 px-4 py-3 bg-[#1a1b1f]/40 hover:bg-[#1a1b1f]/60 transition-colors border-l-2 border-transparent hover:border-white/10"
                                >
                                    {/* Time */}
