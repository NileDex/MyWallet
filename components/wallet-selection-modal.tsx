          ...
          {filteredWallets.length === 0 ? (
            ...
            filteredWallets.map((wallet) => (
              <Button
                key={wallet.name}
                variant="ghost"
                className="w-full justify-start h-12 rounded-none bg-[#151515] text-foreground border border-transparent"
              ...
              >
                <div className="flex items-center space-x-3">
                  ...
                  <span className="font-mono uppercase text-xs tracking-wider">{wallet.name}</span>
                </div>
              </Button>
            ))
          )}
